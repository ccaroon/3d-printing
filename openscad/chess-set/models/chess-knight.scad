...
difference() {
	...
	translate(v = [3.0, 0, 33.4]) {
		translate(v = [-16.5, 2.0, 0]) {
			rotate(a = [90, 0, 0]) {
				union() {
					...
					color(alpha = 1.0, c = "grey") {
						translate(v = [2.4749999999999996, 2.6624999999999996, 4]) {
							scale(v = [0.8, 0.8, 0.8]) {
								resize(newsize = [24.75, 26.625, 0]) {
									linear_extrude(height = 4) {
										import(file = "../images/knight/piper-profile-fill.svg", origin = [0, 0]);
					...
					color(alpha = 1.0, c = "grey") {
						translate(v = [2.4749999999999996, 2.6624999999999996, -3.2]) {
							scale(v = [0.8, 0.8, 0.8]) {
								resize(newsize = [24.75, 26.625, 0]) {
									linear_extrude(height = 4) {
										import(file = "../images/knight/piper-profile-fill.svg", origin = [0, 0]);
					...
					color(alpha = 1.0, c = "black") {
						translate(v = [3.7125000000000004, 3.9937500000000004, 4]) {
							scale(v = [0.7, 0.7, 0.7]) {
								union() {
									resize(newsize = [24.75, 26.625, 0]) {
										linear_extrude(height = 4) {
					...
					color(alpha = 1.0, c = "black") {
						translate(v = [3.7125000000000004, 3.9937500000000004, -2.8]) {
							scale(v = [0.7, 0.7, 0.7]) {
								union() {
									resize(newsize = [24.75, 26.625, 0]) {
										linear_extrude(height = 4) {

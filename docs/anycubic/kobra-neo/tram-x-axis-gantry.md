...
2. Raise the X-Axis Gantry/Arm to slightly above the height of the cans by manually turning the Z-Axis screw from the bottom.
...
4. From the front of the printer, place each can on the bed as far to each side as possible and slide under the X-Axis gantry.
    ...
    - You don't want the can to be to touching the print head or the gantry wheels or any other part.
...
7. Ensure that the outer two wheels on each side are touching the track
    ...
    - Now, if the inner wheel is NOT touching the track, use the 10mm open wrench on the inner wheel's eccentric nut to it move toward the track
    - Once complete, all three wheels on each side should be touching the track, but not too tight against it.
8. Manually lower the X-Axis gantry using the Z-screw until all parts of the gantry are sitting on the cans
...
10. Manually raise the X-Axis gantry and remove the cans.
11. Check that everything is secure..
    - No wiggle or give on either side of the X-Axis gantry arm.
